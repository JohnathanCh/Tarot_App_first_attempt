...
```json
  "homepage": "https://myuser_name.github.io/my-app",
```

or for a GitHub user page:

```json
  "homepage": "https://myuser_name.github.io",
```
...
To publish it at [https://myuser_name.github.io/my-app](https://myuser_name.github.io/my-app), run:
