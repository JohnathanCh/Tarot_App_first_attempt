...
john = User.create({user_name: "John", email: "John@mail.com"})
newReading = Reading.create({reading_title: "reading one", user: john})

loin = User.create({user_name: "Loin", email: "Loin@dongle.com"})
loinReading = Reading.create({reading_title: "Loin's reading", user: loin})
